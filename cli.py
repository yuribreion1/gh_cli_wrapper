...
def create_parser():
    ...
    list_parser.add_argument(
        "--languages", action="store_true", help="Showing repository languages"
    )
    list_parser.add_argument(
        "--tags", action="store_true", help="Display repository tags"
    )
    list_parser.add_argument(
        "--teams", action="store_true", help="Display repository teams"
    )
